                        ...
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                                <div class="col-md-12">
                                    <div class="row>">
                                        <div class="ui-widget">                               
                                            <input class="col-md-12" placeholder="Enter your symptoms or Medical Condition" id="tags">
                                        </div>
                                    </div>
                                ...
                                <div class="item-mask item-mask-strain">
                                    <div class="item-caption text-center">
                                        ...
                                        <h5 class="white"><?php echo $strain->Name; ?></h5>
                                         <p><img class="col-md-6 " src="<?php echo $strain->StarImage; ?>"></p>
                                    </div>
                                </div>
                            </a>
                        </div>
