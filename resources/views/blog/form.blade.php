...
<div class="col-md-12">
						<fieldset><legend> Blog Posts</legend>
				...
				<div class="input-group m-b" style="width:150px !important;">
					...
					<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
								  ...
								  <div class="form-group  " >
									<label for="Entryby" class=" control-label col-md-4 text-left"> Entryby </label>
									<div class="col-md-6">
									  {!! Form::text('entryby', $row['entryby'],array('class'=>'form-control', 'placeholder'=>'',   )) !!} 
									 </div> 
									 <div class="col-md-2">
